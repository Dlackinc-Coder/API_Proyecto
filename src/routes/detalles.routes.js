...
routerDetalles.post("/api/detalles", ValidarDetalles, validadorErrores, DetallesController.crearDetalle);
routerDetalles.get("/api/detalles/:id_pedido", DetallesController.obtenerDetallesPorPedido);
